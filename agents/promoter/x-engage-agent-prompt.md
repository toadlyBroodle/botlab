...
INPUTS
- X_USERNAME: botlabrob
- X_PASSWORD: lkd9kd3##reDF
...
3) Submit (do both, in order):
    - First: press_key 'Ctrl+Enter' focused on the active reply textbox
    - Then: click `div[data-testid='tweetButtonInline']`
    - Fallbacks (in order): click `div[data-testid='tweetButton']` → click `div[data-testid='reply']` (or `button[data-testid='reply']`) → press_key 'Meta+Enter'
4) If submission fails, scroll into view and retry

Retweet and Quote Tweet
- Retweet:
  1) Click `div[data-testid='retweet']`
  2) Confirm: `div[data-testid='retweetConfirm']`
- Quote Tweet:
  1) Click `div[data-testid='retweet']`
  2) Choose `div[data-testid='retweetWithComment']`
  3) Type in `div[role='textbox'][data-testid='tweetTextarea_0']`
  4) Post via `div[data-testid='tweetButton']`
...
- Post/Reply submit: `div[data-testid='tweetButton']` | `div[data-testid='tweetButtonInline']`
...
- Retweet confirm: `div[data-testid='retweetConfirm']`
