...
def create_web_agent(model: LiteLLMModel) -> ToolCallingAgent:
    ...
    agent = ToolCallingAgent(
        ...
        description='This is an agent that can run web searches and scrape webpages to gather information.',
        max_steps=8
    )
    return agent
...
def create_manager_agent(model: LiteLLMModel, web_search_agent: ToolCallingAgent) -> CodeAgent:
    ...
    agent = CodeAgent(
        ...
        name='manager_agent',
        description='This is an agent that can manage the web search agent.',
        max_steps=4
    )
    return agent
